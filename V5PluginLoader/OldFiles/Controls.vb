...
Public Class Controls
    ...
    Private thePluginRegistrationRef As PluginRegistration

    Public Sub New(ByRef thePluginRegistration As PluginRegistration)
        thePluginRegistrationRef = thePluginRegistration
    End Sub

    Public Sub Load(ByVal path As String)       'Laden der Controls
        Dim plugins() As AvailablePlugin
        plugins = PluginServices.FindPlugins(path, "ControlInterface.ControlInterfaceClient")
        If Not plugins Is Nothing Then
            ...
            While i < ControlHosts.Length
                ...
                Try
                    ...
                    ControlHosts(i).Load(PluginServices.CreateInstance(plugins(i)), Variablen, AddressOf AktionLoggen, thePluginRegistrationRef)
                    i += 1
